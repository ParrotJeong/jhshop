...
public class LoggingAdvice {
	...
	// target �޼����� �Ķ���͵� ������ ����մϴ�.
	@Before("execution(* com.jhshop.*.service.*.*(..)) or "
			+ "execution(* com.jhshop.*.dao.*.*(..))")
	...
	@After("execution(* com.jhshop.*.service.*.*(..)) or "
			+ "execution(* com.jhshop.*.*.dao.*.*(..))")
	...
	// target �޼ҵ��� ���� �ð��� �����մϴ�.
	@Around("execution(* com.jhshop.*.service.*.*(..)) or "
			+ "execution(* com.jhshop.*.dao.*.*(..))")
