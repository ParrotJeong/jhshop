...
public class GoodsDAOImpl  implements GoodsDAO{
	...
	@Override
	public List<GoodsVO> selectItGoodsList(String goodsSort ) throws DataAccessException{
		List<GoodsVO> listItGoods=(ArrayList)sqlSession.selectList("mapper.goods.selectItGoodsList",goodsSort);
		   return listItGoods;
	};
